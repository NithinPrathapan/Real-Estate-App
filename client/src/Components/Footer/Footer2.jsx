...
const Footer2 = () => {
  return (
    <div className="footer2 border-t-2 bg-slate-200 mt-4">
    ...
    "
          ...
          <div className="social_icons  flex items-center sm:justify-start justify-center my-3   h-[30px]  w-full mx-auto ">
            <svg
        ...
        <div className="f2">
          ...
          <div className="input_container flex items-center ">
            ...
            <input
              type="text"
              className="bg-slate-200 placeholder:text-black "
